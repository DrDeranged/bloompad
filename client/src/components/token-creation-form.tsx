...
const tokenFormSchema = insertTokenSchema.extend({
...
export function TokenCreationForm() {
  ...
  const createTokenMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: 'Your token has been successfully deployed to the Base network.',
      });
      form.reset();
  ...
  return (
    <section id="create-section" className="py-16 bg-gradient-to-b from-[var(--dark)] to-[var(--dark-secondary)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Create Your Token</h2>
          <p className="text-gray-400">Launch your community token in minutes</p>
        </div>
